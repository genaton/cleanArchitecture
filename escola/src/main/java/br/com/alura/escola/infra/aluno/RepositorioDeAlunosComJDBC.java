...
// para testar declarar a dependencia de um gerenciador de BD como mysqle, h2, etc.
    @Override
    public void matricular(Aluno aluno) {
        try {
            ...
            for (Telefone telefones : aluno.getTelefones() ) {
                ps.setString(1, telefones.getDdd());
                ps.setString(2, telefones.getNumero());
                ps.execute();
    ...
    @Override
    public List<Aluno> listarTodosAnunosMatriculados() {
        try {
